...
export const DAR_DE_BAJA_CONTRATO = Symbol("DAR_DE_BAJA_CONTRATO");
export const ANULAR_CONTRATO = Symbol("ANULAR_CONTRATO");
export const REGISTRAR_RESTITUCION = Symbol("REGISTRAR_RESTITUCION");
